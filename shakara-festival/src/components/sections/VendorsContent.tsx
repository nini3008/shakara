...
import { Search, MapPin, ExternalLink, CreditCard, Instagram, Twitter, Facebook, Linkedin, UtensilsCrossed, Shirt, Palette, Sparkles, Gem, Home, Laptop, Music, Wrench, Store } from 'lucide-react'
          ...
          <div className="mb-12 space-y-6">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              ...
              {categories.map(category => {
                const IconComponent = categoryIconComponents[category]
                return (
                  <button
                    key={category}
...
function VendorCard({ vendor, featured = false }: { vendor: Vendor; featured?: boolean }) {
  ...
  const CategoryIcon = categoryIconComponents[vendor.category]
      ...
      <div className="p-6">
        ...
        <div className="mb-3">
          ...
          <div className="flex items-center gap-2 text-sm mb-3">
            <span className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-gray-700/50 text-gray-300">
